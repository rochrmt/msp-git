<html>
   ...
   <#attempt>
      <#assign senderName = ((args.initiator.properties.firstName!"") + " " + (args.initiator.properties.lastName!""))?trim>
   <#recover>
      <#assign senderName = "">
   </#attempt>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tr>
                                       <td>
                                          ...
                                          <div style="font-size: 14px; margin: 12px 0px 24px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
                                             ...
                                             <p>
                                                <#if senderName != "">
                                                   <b>${senderName}</b> vous a assigné
                                                <#else>
                                                   Vous avez reçu
                                                </#if>
                                                <#if args.workflowPooled == true>
                                                   la tâche partagée suivante (à récupérer) :
                                                <#else>
                                                   la tâche suivante sur la plateforme MSP-GED :
                                                </#if>
                                             </p>
                           ...
                           <tr>
                              <td style="padding: 0px 30px; font-size: 13px;">
                                 Message automatique envoyé par MSP-GED — Ministère de la Santé et de la Population
                              </td>
                           </tr>
                           <tr>
                              <td>
