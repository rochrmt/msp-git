                                    ...
                                    <tr>
                                       <td>
                                          ...
                                          <div style="font-size: 14px; margin: 12px 0px 24px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
                                             ...
                                             <p>Cordialement,<br />
                                             ${person.properties.firstName}<#if person.properties.lastName?exists> ${person.properties.lastName}</#if><br />
                                             <span style="font-size:12px;color:#888;">via MSP-GED — Ministère de la Santé et de la Population</span></p>
                                          </div>
                                       </td>
                                    </tr>
                                 </table>
