...
<@markup id="resources">
   ...
   <link rel="stylesheet" type="text/css" href="${url.context}/res/components/dashboard/msp-dashboard.css?v=1" />
   <script type="text/javascript" src="${url.context}/res/components/dashboard/msp-dashboard.js?v=2"></script>
